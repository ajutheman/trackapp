...
//
//   final List<String> _vehicleTypes = VehicleType.values.where((e) => e != VehicleType.other).toList();
//   final List<String> _vehicleBodyTypes = VehicleBodyType.values.where((e) => e != VehicleBodyType.other).toList();
...
//         bodyType: _selectedVehicleBodyType!.name,
...
//                                 children: [
//                                   Icon(getVehicleTypeIcon(vehicleType), size: 40, color: isSelected ? AppColors.secondary : AppColors.textSecondary),
//                                   const SizedBox(height: 12),
//                                   Text(
//                                     vehicleType.name,
