          ...
          if (showActions) ...[
            ...
            Row(
              children: [
                ...
                IconButton(
                  onPressed: () => _makePhoneCall('9876543210'), // Mock phone number
                  icon: Icon(Icons.call, color: AppColors.primary, size: 24),
                ...
                const SizedBox(width: 10),
                IconButton(
                  onPressed: () => _launchWhatsApp('9876543210'), // Mock WhatsApp number
                  icon: Icon(Icons.info_outline, color: AppColors.success, size: 24),
                  style: IconButton.styleFrom(
