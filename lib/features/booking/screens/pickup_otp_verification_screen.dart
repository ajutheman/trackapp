...
class PickupOtpVerificationScreen extends StatefulWidget {
  ...
  @override
  State<PickupOtpVerificationScreen> createState() => _PickupOtpVerificationScreenState();
}

class _PickupOtpVerificationScreenState extends State<PickupOtpVerificationScreen> with TickerProviderStateMixin {
  ...
  void _generateOtp() {
    ...
    context.read<BookingBloc>().add(GeneratePickupOtp(bookingId: widget.bookingId));
  }
  ...
  void _verifyOtp() {
    ...
    context.read<BookingBloc>().add(VerifyPickupOtp(bookingId: widget.bookingId, code: _otpValue));
  }
    ...
    return Scaffold(
      ...
      body: BlocListener<BookingBloc, BookingState>(
        listener: (context, state) {
          if (state is PickupOtpGenerated) {
            setState(() {
              _isGenerating = false;
            });
                  ...
                  child: Column(
                    children: [
                      Container(
                        ...
                        child: const Icon(Icons.local_shipping_rounded, size: 48, color: Colors.blue),
                      ),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor: _isOtpComplete ? Colors.blue : AppColors.textSecondary,
